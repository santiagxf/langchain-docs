...
### Microsoft Foundry Tools (formerly Azure Cognitive Services)

Install the integration package package:
...
- Image Analysis: [AzureAiServicesImageAnalysisTool](/oss/integrations/tools/azure_ai_services#azureaiimageanalysistool)
- Document Intelligence: [AzureAiServicesDocumentIntelligenceTool](/oss/integrations/tools/azure_ai_services#azureaidocumentintelligencetool)
- Speech to Text: [AzureAiServicesSpeechToTextTool](/oss/integrations/tools/azure_ai_services#azureaispeechtotexttool)
- Text to Speech: [AzureAiServicesTextToSpeechTool](/oss/integrations/tools/azure_ai_services#azureaitexttospeechtool)
- Text Analytics for Health: [AzureAiServicesTextAnalyticsForHealthTool](/oss/integrations/tools/azure_ai_services#azureaitextanalyticshealthtool)
